		...
		public static void Main(string[] args)
		{
			...
			builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
							.AddCookie(option =>
							{
								...
								option.AccessDeniedPath = "/Account/AccessDenined"; //URL đên trang cấm truy cập
			...
			SV21T1020718.BusinessLayers.Configuration.Initialize(connectionString);
			app.Run();
		}
	}
}
